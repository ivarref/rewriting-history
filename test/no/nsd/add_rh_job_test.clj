      ...
      (let [org-history (rh/pull-flat-history conn [:m/id "id"])
        ...
        (let [e (d/q '[:find ?e .
              ...
              eids-to-excise (d/q '[:find [?eid ...]
                                  ...
                                  (d/db conn)
                                  e)
              new-history (->> (d/q '[:find ?n ?e ?a ?v ?t ?o
                                      :in $ ?ee
                                      :where
                                      [?ee :rh/new-history ?n]
                                      [?n :rh/e ?e]
                               ...
                               (vec))]
          (log/info "new history:" new-history)
          (log/info "............" org-history)
          (is (= new-history org-history))
          (log/info "eids to excise is" eids-to-excise))
